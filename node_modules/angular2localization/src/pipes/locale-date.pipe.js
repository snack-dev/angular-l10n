 ...
 */
System.register(['@angular/core', '@angular/common/src/facade/lang', '@angular/common/src/facade/intl', '@angular/common/src/facade/collection', '@angular/common/src/pipes/invalid_pipe_argument_exception', '../services/Intl-support'], function(exports_1, context_1) {
    "use strict";
    ...
    var core_1, lang_1, intl_1, collection_1, invalid_pipe_argument_exception_1, Intl_support_1;
    var LocaleDatePipe;
    return {
        setters:[
            function (core_1_1) {
