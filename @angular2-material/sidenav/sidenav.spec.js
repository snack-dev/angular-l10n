...
function endSidenavTransition(fixture) {
    var sidenav = fixture.debugElement.query(browser_1.By.directive(sidenav_1.MdSidenav)).componentInstance;
...
function main() {
    testing_1.describe('MdSidenav', function () {
         ...
         */
        testing_1.beforeEach(testing_1.injectAsync([testing_1.TestComponentBuilder, xhr_1.XHR], function (tcb, xhr) {
            builder = tcb;
            return Promise.all([
        ...
        testing_1.describe('methods', function () {
            ...
            testing_1.it('open/close() return a promise that resolves after animation end', fakeAsyncAdaptor(function () {
                ...
                var sidenav = fixture.debugElement
                    .query(browser_1.By.directive(sidenav_1.MdSidenav)).componentInstance;
                var called = false;
