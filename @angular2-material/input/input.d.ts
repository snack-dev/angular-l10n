import { AfterContentInit, SimpleChange, OnChanges } from 'angular2/core';
import { ControlValueAccessor } from 'angular2/src/common/forms/directives/control_value_accessor';
import { BaseException } from 'angular2/src/facade/exceptions';
export declare class MdInputPlaceholderConflictException extends BaseException {
    constructor();
}
export declare class MdInputUnsupportedTypeException extends BaseException {
    constructor(type: string);
}
export declare class MdInputDuplicatedHintException extends BaseException {
